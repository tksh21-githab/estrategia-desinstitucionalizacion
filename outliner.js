...
function hover(iNode, over) {
    ...
    if (theme == 'light') {
        img_expanded = 'Expanded.svg';
        img_collapsed = 'Collapsed.svg';
        img_leaf = 'LeafRowHandle.svg';
    } else if (theme == 'dark') {
        img_expanded = 'Expanded-dark.svg';
        img_collapsed = 'Collapsed-dark.svg';
        img_leaf = 'LeafRowHandle-dark.svg';
    }
